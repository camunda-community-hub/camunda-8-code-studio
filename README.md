...
You may like to refer to [the BPMN Primer](https://docs.camunda.io/docs/components/modeler/bpmn/bpmn-primer/) and the docs for [Decision Modeling Notation (DMN)](https://docs.camunda.io/docs/components/modeler/dmn/) in the Camunda 8 documentation.
